...
``` 
**Figure 3. Seed Count differences across Mound Locations.** Mound location on the x-axis and seed count on the y-axis. Each mound location is represented with a different color where B (base of mound) is red, D (surrounding area of mound) is green, E (edge of black garma grass clumps) is blue, and I (interspace between black grama grass clumps) is purple.
