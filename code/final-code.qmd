...
# Introduction
As the climate continues to change from anthropogenic induced emissions, environmental conditions that determine ecosystem composition alter. In Niwot Ridge, Colorado environmental conditions have began to drift from the status quo due to alterations in temperature, soil moisture, and precipitation [1]. The new state of the environment has made it particularly hospitable to woody shrub establishment, altering the composition of the entire ecosystem. 
